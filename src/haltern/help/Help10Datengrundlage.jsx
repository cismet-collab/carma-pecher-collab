...
import logoAis from "./assets/Signet_AIS_RZ.png";
    ...
    <GenericModalMenuSection
      ...
      sectionContent={
        <div>
          ...
          <p>
            Die Starkregengefahrenkarte im AIS Starkregenvorsorge Haltern am See
            ...
            Kantenlänge von 1 m genutzt. Die Wassertiefen und
            ...
            nutzt die Eckwerte 10 cm (hellblau), 30 cm (blau), 50 cm
            (dunkelblau) und 100 cm (violett). Wassertiefen unter 5 cm werden
            nicht mehr farbig ausgeprägt (transparente Darstellung). Zur
            Visualisierung der <strong>Fließgeschwindigkeiten</strong>,
            angegeben in Meter pro Sekunde (m/s), werden die Eckwerte 0,25 m/s
            (gelb), 0,5 m/s (orange), 2,0 m/s (hellrot) und 4 m/s (dunkelrot)
            ...
            wurden nicht explizit als Quellen berücksichtigt. Die Ableitungs-
            und Speicherwirkung des Kanalnetzes wurde über einen pauschalen
            Verlustansatz berücksichtigt. Die Berechnungsergebnisse haben daher
            je nach Berechnungsannahme immer einen Variationsbereich und
            spiegeln in der Regel mittlere Verhältnisse wieder. Je nach Regen
            und Randbedingungen in der Realität können in Teilgebieten die
          ...
          <p>
            Große Seen und Gewässerflächen (z. B. Silbersee und
            Wessel-Datteln-Kanal) und größere Fließgewässer (z. B. die Lippe)
            haben eine geringe Relevanz für die Betrachtung lokaler Starkregen.
            Daher werden keine Ergebnisse für diese Bereiche erzeugt. Im Bereich
            der Hochwassergefahrengewässer (u.a. Lippe) sind die
            Hochwassergefahrenkarten zu berücksichtigen.
          </p>
          <p>
            Die Simulationen basieren auf einem Digitalen Geländemodell (DGM1)
            von Haltern am See. Grundlage hierfür sind flächenhafte
            Höhenmessungen, die das Land NRW turnusmäßig mit einem Laserscanner
            aus einem Flugzeug heraus durchführt (verfügbarer Datenstand 2020).
            Das DGM1 wurde um die Gebäude aus dem Liegenschaftskataster von
            Haltern am See (6/2022) und wichtige verrohrte Gewässerabschnitte
            sowie Geländedurchlässe ergänzt, um eine hydrologisch korrekte
          ...
          <p>
            ...
            an, einen Starkregen (SRI 6) als "Modellregen" sowie einen extremen
            Starkregen abgeleitet aus gemessenen Regenhöhen in Lippramsdorf (SRI
            10), die dann auf ganz Haltern am See angewendet wurden.{" "}
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              Datengrundlage:{" "}
              <strong>Digitale Orthophotos (DOP) des RVR</strong> WMS-Dienst für
              farbige, digitale, georeferenzierte, lagegenaue, entzerrte
              Luftbilder des Regionalverband Ruhr (Verbandsgebiet). (
              <a
                target="_legal"
                href="https://www.rvr.ruhr/daten-digitales/geodaten/luftbilder/"
              >
