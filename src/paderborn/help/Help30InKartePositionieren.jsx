  ...
  return (
    <GenericModalMenuSection
      ...
      sectionContent={
        <div>
          <p>
            Um die Auswirkungen durch Starkregen in einem bestimmten Bereich des Stadtgebietes zu
          ...
          <p>
            ...
            großer Maßstab (Zoomstufe 20) eingestellt und ein Marker <Icon name='map-marker' /> auf
