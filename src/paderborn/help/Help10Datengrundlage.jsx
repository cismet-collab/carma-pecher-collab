...
import logo from "./assets/Signet_AIS_RZ.png";
    ...
    <GenericModalMenuSection
      ...
      sectionContent={
        <div>
          ...
          />
          <p>
            Die Starkregengefahrenkarte im AIS Starkregenvorsorge Paderborn
            ...
            wurden. Zudem kann der zeitliche Verlauf der Fließgeschwindigkeiten
            und der Wassertiefen während der simulierten Starkregenereignisse
            visualisiert werden. Dazu wurde ein Raster der Geländeoberfläche mit
            einer Auflösung von 1x1 m genutzt. Die Wassertiefen und
            ...
            nutzt die Eckwerte 20 cm (hellblau), 40 cm (blau), 75 cm
            (dunkelblau) und {">"} 100 cm (violett). Wassertiefen unter 5 cm
            werden nicht mehr farbig ausgeprägt (transparente Darstellung). Zur
            Visualisierung der <strong>Fließgeschwindigkeiten</strong>,
            angegeben in Meter pro Sekunde (m/s), werden die Eckwerte 0,5 m/s
            (gelb), 2,0 m/s (hellorange), 4,0 m/s (orange) und 6,0 m/s
            (dunkelorange) verwendet. Der untere Grenzwert für die farbige
            Anzeige einer Fließgeschwindigkeit liegt bei 0,2 m/s.
          </p>
          ...
          <p>
            ...
            sowohl die Leistungsfähigkeit des Kanalnetzes, als auch der Überstau
            des Kanalnetzes einen Einfluss auf die Überflutungssituation haben
            kann. Das Abflussverhalten des Kanalnetzes wurde durch eine
            kombinierte Betrachtung berücksichtigt. Je nach Flächennutzung
            liegen verschiedene Oberflächeneigenschaften vor. Diese werden im
            Modell über unterschiedliche Geländerauheiten und zeitlich variable
          ...
          <p>
            ...
            des hydrologischen Einzugsgebiets der Stadt Paderborn. Als Grundlage
            hierfür dienen flächenhafte Höhenmessungen, die das Land NRW
            turnusmäßig mit einem Laserscanner aus einem Flugzeug heraus
            durchführt (Aufnahme durch Laseraltimetrie im Jahr 2018). Das DGM1
            wurde um die Gebäude aus dem Liegenschaftskataster der Stadt
            Paderborn (01/2021) und wichtige verrohrte Gewässerabschnitte sowie
            Geländedurchlässe ergänzt, um eine hydrologisch korrekte
            Abflussberechnung zu gewährleisten. Zusätzlich wurden die Gebäude
            auf Aktualität geprüft und abgerissene oder geplante Gebäude
            gegebenenfalls angepasst. Sehr neue Gebäude, die nach dem
