        ...
        <div>
          ...
          <ul>
            ...
            <li>
              ...
              Verdunstung spielt bei den hier betrachteten kurzen Niederschlägen nur eine
            ...
            <li>
              ...
              wie Straßen das Regenwasser schneller ab.
            </li>

            <li>
              Das Kanalnetz wurde vereinfacht über einen Verlustansatz berücksichtigt. Zu der
              detaillierten Wirkung von Abflüssen innerhalb des Kanalnetzes hat die Kreisstadt Olpe
              gesonderte Fachberechnungen vorliegen (Zentraler Abwasserplan). Die dargestellten
              Starkregen zeichnen sich durch hohe Regenintensitäten oberhalb der Bemessungsgrenze
              des Kanalnetzes aus. Über das Kanalnetz kann zwar eine gewisse Menge an Regenwasser
              aufgenommen und abgeführt werden, allerdings fließen bei den dargestellten Starkregen
              große Anteile oberirdisch ab oder können nicht mehr in das Kanalnetz eintreten.
            </li>
          </ul>
          ...
          <p>
            <strong>
              ...
              daher je nach Randbedingungen in der Realität auch etwas geringere oder höhere
              Wassertiefen zur Folge haben.
            </strong>{" "}
